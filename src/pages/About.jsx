...
const values = [
  ...
  { icon: Eye, title: 'Our Vision', desc: 'To be the most trusted educational institution in Visakhapatnam district, recognized for academic excellence, holistic development, and community impact.' },
